...
USAGE:
python LMA_storm_sort_and_grid.py {network} {year} {month} {day} {start_time} {end_time}
...
if __name__ == '__main__':
    ...
    params = {'stations':(5,99),          # range of allowable numbers of contributing stations
              ...
              'min_points':1}             # minimum number of points per flash
